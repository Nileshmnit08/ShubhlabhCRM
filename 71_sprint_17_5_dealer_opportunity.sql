-- MICRO-SPRINT 17.5: DEALER OPPORTUNITY & ORDER INTENT

-- Safely drop dependent views
...
-- 1. Detailed Demand View (Adding intent_type, expected_rate, and unit)
...
-- 3. Refine Opportunities View (To surface dealer intent and verify Tally sales)
...
SELECT 
    ...
    CASE 
        WHEN crm_pty.relationship_type = 'Dealer' THEN COALESCE(req_det.intent_type, 'Dealer Opportunity')
        ELSE 'Open Requirement' 
