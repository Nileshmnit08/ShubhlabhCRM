...
BEGIN
    ...
    SELECT 
        cg.normalized_phone::TEXT,
        cg.party_id::UUID,
        cg.party_name::TEXT,
        cg.display_phone::TEXT,
        cg.total_calls::BIGINT,
        cg.incoming_count::BIGINT,
        cg.outgoing_count::BIGINT,
        cg.missed_count::BIGINT,
        cg.talk_seconds::BIGINT,
        cg.last_call_at::TIMESTAMPTZ,
        cg.last_call_direction::TEXT,
        cg.events_json::JSONB,
        cg.total_group_count::BIGINT,
        cg.grand_total_calls::BIGINT,
        cg.grand_incoming::BIGINT,
        cg.grand_outgoing::BIGINT,
        cg.grand_missed::BIGINT,
        cg.grand_talk_seconds::BIGINT,
        cg.grand_known::BIGINT,
        cg.grand_unknown::BIGINT
