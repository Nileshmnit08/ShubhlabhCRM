-- MICRO-SPRINT 13.3: DORMANT CUSTOMER OPPORTUNITY
-- Use validated dormant/reactivation information to prioritize customers with genuine reactivation potential.
...
-- 2. Reactivation Opportunities (Approved by Management)
SELECT 
    react_int.party_id,
